...
local FamilyService = require(Services:WaitForChild("FamilyService"))
...
FamilyService.Init()
FamilyService.SetupPlayerInteraction()
MarketService.Init()
ProductService.Init()
